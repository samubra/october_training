<?php return [
    ...
    'order'=> [
        ...
        'email'=>'电子邮件地址：',
        'phone'=>'电话：',
        'billing_details_name'=>'名称',
        'billing_details_value'=>'值',
        'shipping_info_name'=>'名称',
        'shipping_info_value'=>'值',
        'id'=>'ID',
    ...
    'shipping_methods'=> [
        'free_shipping'=>'免费送货',
        'free_shipping_description'=>'免运费是一种特殊的方法,可以通过优惠券和最低消费来触发。',
    ]
];
